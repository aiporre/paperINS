...
What we propose in this work is to extend the idea of series non-linear complementary observer from \cite{Scandaro2011} who also combines pasive version of the complementaty filter on SO(3) \cite{Mahony2008} attitude non-linear complementary observer. We deem reduce prediction errors by pre-computing the rotation matrix applying  a observador optimo tipo EKF de orientacion en cuaterniones para la obtencion de la determinacion optima de la matriz de rotacion, dentro del algoritmo de observadores en cascada tipo filtro complementario en SO(3) de Mahony-Scandaroli, mejora la calidad de la estimacion de la informacion de navegacion.}\par
